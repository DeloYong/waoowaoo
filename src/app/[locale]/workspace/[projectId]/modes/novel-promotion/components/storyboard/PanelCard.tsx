  ...
  return (
    ...
    >
      ...
      {!isModifying && !isDeleting && (
        <button
          onClick={onDelete}
          className="absolute -top-2 -right-2 z-10 opacity-0 group-hover/card:opacity-100 transition-opacity bg-[var(--wuhu-neon-pink)] hover:bg-[var(--wuhu-neon-pink)] text-white w-5 h-5 rounded-full flex items-center justify-center text-xs shadow-md"

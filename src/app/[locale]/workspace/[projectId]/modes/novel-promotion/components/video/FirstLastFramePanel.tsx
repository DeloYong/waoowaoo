...
export default function FirstLastFramePanel({
  ...
  return (
    <div className="mb-2 space-y-2">
      <div className="p-2 bg-[var(--wuhu-neon-purple)]/20 border border-[var(--wuhu-neon-purple)]/40 rounded-lg">
        <div className="flex items-center gap-2 text-xs text-[var(--wuhu-neon-purple)] mb-2">
        ...
        <div className="flex gap-2 items-center">
          <div className="flex-1 bg-[var(--wuhu-bg-surface)] rounded overflow-hidden relative" style={{ aspectRatio: cssAspectRatio }}>
            {panel.imageUrl && (
            ...
            <span className="absolute bottom-1 left-1 bg-gradient-to-r from-[var(--wuhu-neon-purple)] to-[var(--wuhu-neon-pink)] text-white text-[10px] px-1 rounded">{t("firstLastFrame.firstFrame")}</span>
          </div>
          <AppIcon name="arrowRight" className="w-4 h-4 text-[var(--wuhu-neon-purple)]" />
          <div className="flex-1 bg-[var(--wuhu-bg-surface)] rounded overflow-hidden relative" style={{ aspectRatio: cssAspectRatio }}>
            {nextPanel.imageUrl && (
              <MediaImageWithLoading
        ...
        <div className="mt-2">
          <div className="flex items-center justify-between mb-1">
            <span className="text-xs text-[var(--wuhu-neon-purple)] font-medium">{t("firstLastFrame.customPrompt")}</span>
            {hasCustomPrompt && (
              <button
                onClick={() => onResetPrompt(panelKey)}
                className="text-xs text-[var(--wuhu-neon-purple)] hover:text-[var(--wuhu-neon-purple)] underline"
              >

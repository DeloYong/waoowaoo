  ...
  return (
    <div className="fixed top-24 right-6 z-40 flex gap-3">
      <button
        ...
        className="bg-[var(--wuhu-bg-surface)] border border-white/20 hover:bg-white/5 rounded-lg text-white/70 hover:text-white transition-all flex items-center gap-2 px-4 py-3 rounded-3xl text-[white]"
      >

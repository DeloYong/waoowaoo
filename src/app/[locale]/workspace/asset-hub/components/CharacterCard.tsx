            ...
            <div className="col-span-3 bg-[var(--wuhu-bg-card)] border border-[var(--wuhu-neon-purple)]/20 rounded-xl hover:border-[var(--wuhu-neon-pink)] hover:shadow-[0_0_25px_rgba(255,100,200,0.3)] transition-all duration-300 p-4 relative">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="bg-[var(--wuhu-neon-purple)]/30 text-white px-2 py-0.5 text-xs">{appearance.changeReason}</span>
                        {isPrimaryAppearance ? (
                            <span className="bg-gradient-to-r from-[var(--wuhu-neon-purple)] to-[var(--wuhu-neon-pink)] text-white px-2 py-0.5 text-xs">{tAssets('character.primary')}</span>
                        ) : (
                            <span className="bg-[var(--wuhu-neon-purple)]/30 text-white px-2 py-0.5 text-xs">{tAssets('character.secondary')}</span>
                        )}
                    </div>
                    <div className="flex items-center gap-1">
                        ...
                        }} className="bg-[var(--wuhu-neon-purple)]/20 flex items-center justify-center hover:bg-[var(--wuhu-neon-purple)]/30 transition-all h-6 w-6 rounded-md">
                        ...
                        return (
                            <div key={index} className="relative group/thumb">
                                ...
                                >
                                    ...
                                    />
                                    <div className={`absolute bottom-2 left-2 text-xs px-2 py-0.5 rounded ${isSelected ? 'bg-gradient-to-r from-[var(--wuhu-neon-purple)] to-[var(--wuhu-neon-pink)] text-white' : 'bg-[var(--wuhu-neon-purple)]/30 text-white'}`}>
                ...
                {showDeleteMenu && appearanceCount > 1 && (
                    <>
                        ...
                        <div className="absolute right-4 top-12 z-20 bg-[var(--wuhu-bg-card)] border border-[var(--wuhu-neon-purple)]/20 rounded-xl hover:border-[var(--wuhu-neon-pink)] hover:shadow-[0_0_25px_rgba(255,100,200,0.3)] transition-all duration-300-modal py-1 min-w-[120px]">
                            <button onClick={handleDeleteAppearance} className="bg-[var(--wuhu-neon-purple)]/20 flex items-center justify-center hover:bg-[var(--wuhu-neon-purple)]/30 transition-all w-full justify-start rounded-none px-3 py-1.5 text-left text-xs">{tAssets('image.deleteThis')}</button>
                            <button onClick={() => { setShowDeleteMenu(false); setShowDeleteConfirm(true) }} className="bg-[var(--wuhu-neon-purple)]/20 flex items-center justify-center hover:bg-[var(--wuhu-neon-purple)]/30 transition-all w-full justify-start rounded-none px-3 py-1.5 text-left text-xs text-[var(--wuhu-neon-pink)]">{tAssets('character.deleteWhole')}</button>
                        </div>
                    </>
                )}
                ...
                {showDeleteConfirm && (
                    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
                        <div className="bg-[var(--wuhu-bg-card)] border border-[var(--wuhu-neon-purple)]/20 rounded-xl hover:border-[var(--wuhu-neon-pink)] hover:shadow-[0_0_25px_rgba(255,100,200,0.3)] transition-all duration-300-modal p-4 m-4 max-w-sm">
                            <p className="mb-4 text-sm text-white">{t('confirmDeleteCharacter')}</p>
        ...
        <div className="bg-[var(--wuhu-bg-card)] border border-[var(--wuhu-neon-purple)]/20 rounded-xl hover:border-[var(--wuhu-neon-pink)] hover:shadow-[0_0_25px_rgba(255,100,200,0.3)] transition-all duration-300 overflow-hidden relative group">
            ...
            <div className="p-3">
                <div className="flex items-center justify-between">
                    <h3 className="font-medium text-white text-sm truncate">{character.name}</h3>
                    <div className="flex items-center gap-1">
                        {/* 编辑按钮 */}
                        <button
                        ...
                        {/* 删除按钮 */}
                        <button onClick={() => appearanceCount <= 1 ? setShowDeleteConfirm(true) : setShowDeleteMenu(!showDeleteMenu)} className="bg-[var(--wuhu-neon-purple)]/20 flex items-center justify-center hover:bg-[var(--wuhu-neon-purple)]/30 transition-all h-6 w-6 rounded-md text-[var(--wuhu-neon-pink)] opacity-0 group-hover:opacity-100">
                ...
                {appearance?.description && <p className="mt-2 text-xs text-white/70 line-clamp-2">{appearance.description}</p>}
            ...
            {showDeleteMenu && appearanceCount > 1 && (
                <>
                    <div className="fixed inset-0 z-10" onClick={() => setShowDeleteMenu(false)} />
                    <div className="absolute right-3 top-auto bottom-16 z-20 bg-[var(--wuhu-bg-card)] border border-[var(--wuhu-neon-purple)]/20 rounded-xl hover:border-[var(--wuhu-neon-pink)] hover:shadow-[0_0_25px_rgba(255,100,200,0.3)] transition-all duration-300-modal py-1 min-w-[120px]">
                        <button onClick={handleDeleteAppearance} className="bg-[var(--wuhu-neon-purple)]/20 flex items-center justify-center hover:bg-[var(--wuhu-neon-purple)]/30 transition-all w-full justify-start rounded-none px-3 py-1.5 text-left text-xs">{tAssets('image.deleteThis')}</button>
                        <button onClick={() => { setShowDeleteMenu(false); setShowDeleteConfirm(true) }} className="bg-[var(--wuhu-neon-purple)]/20 flex items-center justify-center hover:bg-[var(--wuhu-neon-purple)]/30 transition-all w-full justify-start rounded-none px-3 py-1.5 text-left text-xs text-[var(--wuhu-neon-pink)]">{tAssets('character.deleteWhole')}</button>
                    </div>
                </>

...
export default function LongTextDetectionPrompt({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[120] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
      onMouseDown={(event) => {
    ...
    >
      <div className="bg-[var(--wuhu-bg-card)] border border-[var(--wuhu-neon-purple)]/30 shadow-[0_0_40px_rgba(167,87,255,0.2)] rounded-xl w-full max-w-lg rounded-2xl border border-[rgba(167, 87, 255, 0.2)] p-6 shadow-[0_20px_80px_-32px_rgba(15,23,42,0.45)]">
        <div className="space-y-5">
          ...
          <div className="flex flex-col gap-3 pt-1">
            ...
            <button
              type="button"
              onClick={onContinue}
              className="w-full py-2.5 text-sm text-[rgba(255,255,255,0.5)] transition-colors hover:text-[rgba(255,255,255,0.7)]"
            >
              {copy.continueLabel}

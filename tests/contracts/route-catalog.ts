...
const ROUTE_FILES = [
  ...
  'src/app/api/admin/platform-keys/models/route.ts',
  'src/app/api/admin/platform-keys/pipeline-models/route.ts',
  'src/app/api/admin/platform-keys/test/route.ts',
  ...
  'src/app/api/assets/[assetId]/save-to-global/route.ts',
  'src/app/api/assets/reference-upload/route.ts',
  ...
  'src/app/api/projects/[projectId]/editor/generate/route.ts',
  ...
  'src/app/api/cron/generate-daily-stats/route.ts',
  ...
  'src/app/api/user/invite/activate/route.ts',
  'src/app/api/user/invite/route.ts',
